...
//tealium universal tag - utag.sender.20067 ut4.0.201801112152, Copyright 2018 Tealium.com Inc. All Rights Reserved.
try{
  (function(id, loader) {
    var u = {"id" : id};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "tag_type" : "script",
          "base_url" : "",
          "secure_base_url" : "https://engager.co/embeds/engagers/p/r1/engager.js",
          "static_params" : "",
          "cachebust" : "disabled",
          "cachevar" : "" || "_rnd"
        };
        ...
        utag.DB("send:263:COMPLETE");
      }
    };
    utag.o[loader].loader.LOAD(id);
  }("263", "intel.profile-ssg.intel"));
} catch (error) {
  utag.DB(error);
}
